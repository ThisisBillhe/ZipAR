...
class FlexARItemProcessor(MMConvItemProcessor):
    ...
    def __init__(
        ...
        self.chameleon_ori_vocab = chameleon_vae_ori.VocabInfo(
            json.load(open("/mnt/workspace/Lumina-mGPT/lumina_mgpt/ckpts/chameleon/tokenizer/text_tokenizer.json", encoding="utf8"))["model"]["vocab"]
        )
        ...
        self.chameleon_ori_image_tokenizer = chameleon_vae_ori.ImageTokenizer(
            cfg_path="/mnt/workspace/Lumina-mGPT/lumina_mgpt/ckpts/chameleon/tokenizer/vqgan.yaml",
            ckpt_path="/mnt/workspace/Lumina-mGPT/lumina_mgpt/ckpts/chameleon/tokenizer/vqgan.ckpt",
            device="cuda",
        )
